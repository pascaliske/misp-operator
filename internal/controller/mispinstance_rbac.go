...
func (r *MispInstanceReconciler) createInstanceServiceAccount(mispInstance *mispv1alpha1.MispInstance) *corev1apply.ServiceAccountApplyConfiguration {
	return corev1apply.
		ServiceAccount(mispInstance.GetName(), mispInstance.Namespace).
...
func (r *MispInstanceReconciler) reconcileServiceAccount(ctx context.Context, mispInstance *mispv1alpha1.MispInstance) error {
	...
	// reconcile misp instance service account
	return r.Apply(ctx, r.createInstanceServiceAccount(mispInstance), options)
}
